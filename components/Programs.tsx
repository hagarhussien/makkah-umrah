...
const programs: Program[] = [
  {
    ...
    lead:
      "إقامة في أحد الفنادق المتعاقد معها بشارع إبراهيم الخليل، من أول كوبري المسفلة حتى آخر الشارع، وجميعها تقع خلف برج الساعة مباشرة. ويتم تسكين المعتمرين في الفندق المناسب من بين الفنادق المتعاقد معها، وفقًا للمتاح وميزانية الرحلة.",
    features: [
    ...
    price: `تبدأ من ${site.price.from}`,
    priceUnit: `${site.price.currency} للفرد`, includes: ["تأشيرة العمرة", "إقامة في شارع إبراهيم الخليل", "رحلة جماعية ذهابًا وعودة", "متابعة مباشرة من مشرف الرحلة"],
    cta: "اسأل عن هذا البرنامج",
    fine: "السعر يبدأ من هذا الرقم ويختلف حسب الفندق المختار وعدد الأفراد في الغرفة، ويتغيّر مع تغيّر أسعار الطيران، فتواصل معنا لمعرفة السعر الحالي.",
  },
  {
    key: "vip",
    tab: "عمرة VIP",
